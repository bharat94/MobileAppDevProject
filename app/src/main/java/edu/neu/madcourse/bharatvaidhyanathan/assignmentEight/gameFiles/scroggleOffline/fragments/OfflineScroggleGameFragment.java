...
import edu.neu.madcourse.bharatvaidhyanathan.assignmentEight.gameFiles.scroggleOffline.TileScrobble;
...
public class OfflineScroggleGameFragment extends Fragment {
...
//                        }
                        ...
                        if(temp==-1 || isNeighbor(fLarge1, temp) ){
                            ...
                            ((OfflineScroggleGameActivity) getActivity()).displayword(phaseTwoString);
                            ...
                            if(isTransition) {
                                ...
                                if (positionMemory[fLarge].get(positionMemory[fLarge].size() - 1) == fSmall) {
                                    ...
                                    if (words[fLarge].length() > 2 && GlobDict.getInstance(getActivity()).search(words[fLarge])) {
                                        ...
                                        ((OfflineScroggleGameActivity) getActivity()).displayword(words[fLarge]);
                                    } else {
                                        ((OfflineScroggleGameActivity) getActivity()).displayword("");
                                    }
                                    updateScore(5);
                                } else {
                                    if (words[fLarge].length() > 2 && GlobDict.getInstance(getActivity()).search(words[fLarge]))
    ...
    public void updateScore(int factor){
        ...
        ((OfflineScroggleGameActivity) getActivity()).setScore(score);
