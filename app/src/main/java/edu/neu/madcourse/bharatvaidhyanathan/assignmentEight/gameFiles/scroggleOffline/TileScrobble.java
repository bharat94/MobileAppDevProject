...
***/
package edu.neu.madcourse.bharatvaidhyanathan.assignmentEight.gameFiles.scroggleOffline;
...
public class TileScrobble {
   ...
   public TileScrobble deepCopy() {
      TileScrobble tile = new TileScrobble(mGame);
      tile.setOwner(getOwner());
      if (getSubTiles() != null) {
         TileScrobble newTiles[] = new TileScrobble[9];
         TileScrobble oldTiles[] = getSubTiles();
   ...
   public TileScrobble[] getSubTiles() {
      return mSubTiles;
   }

   public void setSubTiles(TileScrobble[] subTiles) {
